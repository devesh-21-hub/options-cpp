/**
 * @file TridiagonalMatrixAlgorithm.cc
 * @author Devesh Kumar (deveshkumar21101@gmail.com)
 * @brief Tridiagonal Matrix Algorithm ("Thomas Algorithm")
 * @version 0.1
 * @date 2022-11-16
 *
 */
...
int main(int argc, char **argv)
{
    ...
    vector<double> a(N - 1, -r / 2.0);
    vector<double> b(N, 1.0 + r);
    vector<double> c(N - 1, -r / 2.0);
